...
-- ALTER command to add a new column in the DEPARTMENT table
ALTER TABLE DEPARTMENT ADD dept_head VARCHAR(255);
SELECT * FROM DEPARTMENT;

-- UPDATE command to update the newly added dept_head column
UPDATE DEPARTMENT SET dept_head = 'John Doe' WHERE deptname = 'Management';
SELECT * FROM DEPARTMENT;

-- DROP command to delete the ITEM table
DROP TABLE ITEM;

-- SELECT command to get all employees from the EMP table who work in the 'Management' department
SELECT * FROM EMP WHERE deptname = 'Management';
